    ...
    <nav className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 py-4 space-y-3">
          <Link href="/" className="block text-sm text-gray-700 hover:text-gray-900 py-1" onClick={() => setMenuOpen(false)}>Home</Link>
          <Link href="/products" className="block text-sm text-gray-700 hover:text-gray-900 py-1" onClick={() => setMenuOpen(false)}>All Products</Link>
          <Link href="/about" className="block text-sm text-gray-700 hover:text-gray-900 py-1" onClick={() => setMenuOpen(false)}>About</Link>
          <Link href="/contact" className="block text-sm text-gray-700 hover:text-gray-900 py-1" onClick={() => setMenuOpen(false)}>Contact</Link>
        </div>
      )}
    </nav>
  );
